...
var UploadComponent = (function () {
    function UploadComponent(uploadService, localization, navigation, _ngZone, wrapper, rtl) {
        ...
        this.async = {
            ...
            removeHeaders: new http_1.Headers(),
            removeMethod: http_1.RequestMethod.Post,
            removeUrl: "",
            saveField: "files",
            saveHeaders: new http_1.Headers(),
            saveMethod: http_1.RequestMethod.Post,
            saveUrl: "",
    ...
    Object.defineProperty(UploadComponent.prototype, "withCredentials", {
         ...
         * or the [`upload`]({% slug api_upload_uploadevent_kendouiforangular %}) event.
         */
    ...
    Object.defineProperty(UploadComponent.prototype, "restrictions", {
         ...
         * refer to the API documentation on [`FileRestrictions`]({% slug api_upload_filerestrictions_kendouiforangular %}).
         */
