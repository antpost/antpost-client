...
var FileListComponent = (function () {
    ...
    FileListComponent.prototype.itemActionHandler = function (key) {
        ...
        if (key === navigation_service_1.Keys.esc && files[0].state === file_info_1.FileState.Uploading) {
            this.uploadService.cancelFiles(uid);
            this.navigation.focusSelectButton();
            return;
        }
        if (key === navigation_service_1.Keys.enter && files[0].state === file_info_1.FileState.Failed) {
            this.uploadService.retryFiles(uid, this.async);
            return;
        }
        if (key === navigation_service_1.Keys.delete) {
            if (files[0].state === file_info_1.FileState.Uploading) {
                this.uploadService.cancelFiles(uid);
            }
