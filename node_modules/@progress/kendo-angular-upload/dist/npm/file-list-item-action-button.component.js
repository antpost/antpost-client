 ...
 * @hidden
 */
var FileListItemActionButtonComponent = (function () {
    ...
    FileListItemActionButtonComponent.prototype.setActionButtonClasses = function (file) {
        ...
        return {
            'k-icon': true,
            'k-cancel k-i-deny': file.state === file_info_1.FileState.Uploading,
            'k-delete k-i-x': file.state !== file_info_1.FileState.Uploading
        };
    };
    FileListItemActionButtonComponent.prototype.setActionButtonTitle = function (file) {
        if (file.state === file_info_1.FileState.Uploading) {
    ...
    FileListItemActionButtonComponent.prototype.isVisible = function (file, type) {
        if (type === 'retry') {
            return file.state === file_info_1.FileState.Failed ? true : false;
        }
        if ((file.state === file_info_1.FileState.Uploaded || file.state === file_info_1.FileState.Initial) && !this.async.removeUrl) {
            return false;
        }
        return true;
    };
...
FileListItemActionButtonComponent.propDecorators = {
    ...
    'retryButton': [{ type: core_1.ViewChild, args: ["retryButton",] },],
    'actionButton': [{ type: core_1.ViewChild, args: ["actionButton",] },],
};
