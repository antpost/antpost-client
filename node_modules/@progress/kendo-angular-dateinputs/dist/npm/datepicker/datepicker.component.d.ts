import { EventEmitter, NgZone, OnChanges } from '@angular/core';
 ...
 */
export declare class DatePickerComponent implements ControlValueAccessor, OnChanges {
    zone: NgZone;
    ...
    constructor(zone: NgZone, localization: LocalizationService);
    /**
     * @hidden
     */
