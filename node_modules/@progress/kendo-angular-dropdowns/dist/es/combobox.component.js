...
var ComboBoxComponent = (function () {
    ...
    ComboBoxComponent.prototype.subscribeEvents = function () {
        ...
        this.navigationSubscribtion = Observable.merge(this.navigationService.up, this.navigationService.down, this.navigationService.home, this.navigationService.end).subscribe(function (event) { return _this.navigate(event.index); });
