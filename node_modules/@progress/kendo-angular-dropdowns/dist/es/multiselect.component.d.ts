...
import { ElementRef, OnDestroy, OnChanges, EventEmitter, AfterContentChecked, AfterViewInit } from '@angular/core';
...
export declare class MultiSelectComponent implements OnDestroy, OnChanges, AfterContentChecked, AfterViewInit {
    ...
    constructor(rtl: boolean, selectionService: SelectionService, navigationService: NavigationService);
