import { ElementRef, EventEmitter, OnDestroy, OnChanges, SimpleChange, NgZone } from '@angular/core';
...
export declare class DropDownListComponent implements ControlValueAccessor, OnDestroy, OnChanges {
    ...
    constructor(rtl: boolean, selectionService: SelectionService, navigationService: NavigationService, zone: NgZone);
    /**
     * @hidden
     */
    onFilterFocus(): void;
